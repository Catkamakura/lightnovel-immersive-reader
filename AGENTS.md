...
| `package.json` | npm metadata + `verify*` scripts. The userscript header `@version` (currently **1.14.1**) is the source of truth for the reader's version. |
